...
//   phoneLink.innerText = user.phone;
//   cardBody.append(phoneLink);
//   let br2 = document.createElement("br");
//   cardBody.append(br2);
//   let webLink = document.createElement("a");
//   webLink.setAttribute("href", "https://" + user.website);
//   webLink.innerText = user.website;
//   cardBody.append(webLink);
...
//   let companyPhrase = document.createElement("p");
//   companyPhrase.innerText = user.company.catchPhrase;
//   company.append(companyPhrase);
//   let address = document.createElement("p");
//   address.innerText = user.address.city.concat(
//     ", ",
//     user.address.street,
//     ", ",
//     user.address.suite,
